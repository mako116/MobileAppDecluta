...
const AllTabs: React.FC = () => {
    ...
    const items: Omit<Notification, 'billNumber'>[] = [
      {
        ...
        description: '₦25,000 (In Escrow)',
        location:'Agbowo UI, Ibadan, Oyo',
        image: require('../../../../assets/images/New folder/Frame 648006.png'),
  ...
  const renderButtons = (title: string) => {
    ...
    if (lowerTitle.includes('order completed')) {
      return (
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
          ...
          <BoxButton width="50%" title="Rate Seller" backgroundColor="#DEBC8E" borderWidth={0} onPress={() => {}} borderColor="" />
        </View>
      );
    } else if (lowerTitle.includes('pickup your')) {
      return (
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
          <BoxButton width="45%" title="View Details" backgroundColor="#fff" borderWidth={1} onPress={() =>router.push("/(routes)/order/order-details")} borderColor="#463E31" />
      ...
      return (
        <BoxButton width="100%" title="Confirm Pickup" backgroundColor="#DEBC8E" borderWidth={0} onPress={() => {}} />
      );
    }
  };
