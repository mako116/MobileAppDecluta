        ...
        <SafeAreaView style={welcomePin.container}>
            <ScrollView style={{ flex: 1 }} scrollEventThrottle={16}>
                <View style={SignUpStyles.header}>
                    ...
                    <View style={welcomePin.pinContainer}>
                        <Text style={[welcomePin.pinText,{textAlign:"center"}]}>Enter your Pin </Text>
                        ...
                        <View style={welcomePin.calculatorContainer}>
                            ...
                            <View style={welcomePin.calculatorRow}>
                                <TouchableOpacity onPress={handleFingerprint} style={welcomePin.calculatorButton}>
            ...
            >
                <View style={welcomePin.modalBackground}>
                    ...
                    <Image source={require("@/assets/images/fingerptrint1.png")}   />

                        
                        <Text style={welcomePin.modalTitle}>Error! Biometrics Disabled</Text>
                        ...
                        <TouchableOpacity style={welcomePin.modalButton} onPress={handleCloseModal}>
