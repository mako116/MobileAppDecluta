...
const [showMore, setShowMore] = useState(false);
  ...
  return (
    <ScrollView style={{ flex: 1 }} scrollEventThrottle={16}>
      ...
      <View style={{ alignItems: "center", flexDirection: "row", justifyContent: "center", paddingVertical: 14 }}>
...
<TouchableOpacity onPress={goBackEmail} style={SignUpStyles.socialButton}>
      ...
      <View style={{ margin: "auto", paddingVertical: 14 }}>
         {/* <Image style={{ height: 20, width: 20, resizeMode: "contain" }} source={require("../../../../assets/images/newimages/Down 2.png")} /> */}
         {!showMore && (
